...
export const projectsData = [
    {
        id: 1,
        name: 'ETL Pipeline & SCD Type 2 Implementation using PySpark and Databricks',
        description: "Designed and developed an enterprise-style ETL framework for processing structured CSV datasets across Raw, Work, and Conformed data zones. Implemented data quality validations, metadata-driven ingestion, audit logging, and Slowly Changing Dimension (SCD Type 2) logic using PySpark and Delta Tables.",
        tools: ['Pyspark','SQL'],
        role: 'Admin',
        code: '',
        demo: '',
